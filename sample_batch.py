...
def main():
    ...
    cfg.model_path = './trained_models/model160000.pt'
    cfg.sty_img_path = './reference_image/test/id_0/00019.png'
    cfg.img_save_path = './result/ret-16w/id-0'
    infer(cfg)

    #测试id_1
    print("第二组数据")
    cfg =  copy.deepcopy(tmp_cfg)
    cfg.model_path = './trained_models/model160000.pt'
    cfg.sty_img_path = './reference_image/test/id_1/00019.png'
    cfg.img_save_path = './result/ret-16w/id-1'
    infer(cfg)
    ...
    cfg =  copy.deepcopy(tmp_cfg)
    cfg.model_path = './trained_models/model160000.pt'
    cfg.sty_img_path = './reference_image/test/id_5/00019.png'
    cfg.img_save_path = './result/ret-16w/id-5'
    infer(cfg)
...
def infer(cfg):
    ...
    while len(all_images) * cfg.batch_size < cfg.num_samples:
        model_kwargs = {}
        classes = th.tensor([i for i in char_idx[ch_idx:ch_idx + cfg.batch_size]], device=th.device("cpu"))
